 ...
 * @generated
 */
public class Exception2ItemSemanticEditPolicy extends CrystalBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public Exception2ItemSemanticEditPolicy() {
		super(CrystalElementTypes.Exception_3181);
	}
