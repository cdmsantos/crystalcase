...
import crystal.diagram.edit.commands.OptionsTransitionCreateCommand;
import crystal.diagram.edit.commands.OptionsTransitionReorientCommand;
...
import crystal.diagram.edit.parts.OptionsOptionsCase_statementsCompartmentEditPart;
 ...
 * @generated
 */
public class OptionsItemSemanticEditPolicy extends CrystalBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public OptionsItemSemanticEditPolicy() {
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (CrystalVisualIDRegistry.getVisualID(incomingLink) == OptionsTransitionEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (CrystalVisualIDRegistry.getVisualID(outgoingLink) == OptionsTransitionEditPart.VISUAL_ID) {
	...
	*/
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (CrystalElementTypes.OptionsTransition_4003 == req.getElementType()) {
			return getGEFWrapper(new OptionsTransitionCreateCommand(req, req.getSource(), req.getTarget()));
		}
		return null;
	}
	...
	protected Command getReorientRelationshipCommand(ReorientRelationshipRequest req) {
		...
		case OptionsTransitionEditPart.VISUAL_ID:
			return getGEFWrapper(new OptionsTransitionReorientCommand(req));
		}
