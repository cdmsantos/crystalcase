 ...
 * @generated
 */
public class LoopLoopInterations_statementsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getLoopLoopInterations_statementsCompartment_7131SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getLoopLoopInterations_statementsCompartment_7131SemanticChildren((View) getHost().getModel());
