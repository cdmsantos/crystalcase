 ...
 * @generated
 */
public class LoopLoopLoopStatementsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getLoopLoopLoopStatementsCompartment_7084SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getLoopLoopLoopStatementsCompartment_7084SemanticChildren((View) getHost().getModel());
