 ...
 * @generated
 */
public class ProcedureProcedureExecutablePartCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getProcedureProcedureExecutablePartCompartment_7002SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getProcedureProcedureExecutablePartCompartment_7002SemanticChildren((View) getHost()
						.getModel());
