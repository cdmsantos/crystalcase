 ...
 * @generated
 */
public class CaseCaseElseStatementsCompartment7CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getCaseCaseElseStatementsCompartment_7103SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getCaseCaseElseStatementsCompartment_7103SemanticChildren((View) getHost().getModel());
