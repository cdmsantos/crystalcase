 ...
 * @generated
 */
public class IfIfTrue_statementsCompartment5CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getIfIfTrue_statementsCompartment_7133SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getIfIfTrue_statementsCompartment_7133SemanticChildren((View) getHost().getModel());
