 ...
 * @generated
 */
public class FunctionFunctionReturnPartCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getFunctionFunctionReturnPartCompartment_7007SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getFunctionFunctionReturnPartCompartment_7007SemanticChildren((View) getHost()
						.getModel());
