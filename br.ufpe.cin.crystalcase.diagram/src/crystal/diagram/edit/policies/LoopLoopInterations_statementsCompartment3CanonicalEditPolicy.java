 ...
 * @generated
 */
public class LoopLoopInterations_statementsCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getLoopLoopInterations_statementsCompartment_7135SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getLoopLoopInterations_statementsCompartment_7135SemanticChildren((View) getHost().getModel());
