 ...
 * @generated
 */
public class OptionsOptionsCase_statementsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CrystalPackage.eINSTANCE.getOptions_Case_statements();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getOptionsOptionsCase_statementsCompartment_7132SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getOptionsOptionsCase_statementsCompartment_7132SemanticChildren((View) getHost().getModel());
