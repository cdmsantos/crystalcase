 ...
 * @generated
 */
public class ForForInterations_statementsCompartment6CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getForForInterations_statementsCompartment_7151SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getForForInterations_statementsCompartment_7151SemanticChildren((View) getHost().getModel());
