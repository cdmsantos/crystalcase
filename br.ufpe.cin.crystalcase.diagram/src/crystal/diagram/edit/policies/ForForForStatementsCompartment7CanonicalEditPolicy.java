 ...
 * @generated
 */
public class ForForForStatementsCompartment7CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getForForForStatementsCompartment_7073SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getForForForStatementsCompartment_7073SemanticChildren((View) getHost().getModel());
