 ...
 * @generated
 */
public class WhileWhileInterations_statementsCompartment6CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getWhileWhileInterations_statementsCompartment_7150SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getWhileWhileInterations_statementsCompartment_7150SemanticChildren((View) getHost().getModel());
