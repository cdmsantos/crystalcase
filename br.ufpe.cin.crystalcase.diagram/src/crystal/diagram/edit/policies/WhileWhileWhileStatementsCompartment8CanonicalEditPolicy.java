 ...
 * @generated
 */
public class WhileWhileWhileStatementsCompartment8CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getWhileWhileWhileStatementsCompartment_7026SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getWhileWhileWhileStatementsCompartment_7026SemanticChildren((View) getHost().getModel());
