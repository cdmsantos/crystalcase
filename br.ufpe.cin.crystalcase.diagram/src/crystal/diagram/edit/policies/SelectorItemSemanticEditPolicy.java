...
import crystal.diagram.edit.commands.SelectorTransitionCreateCommand;
import crystal.diagram.edit.commands.SelectorTransitionReorientCommand;
...
import crystal.diagram.edit.parts.SelectorSelectorCaseStatementsCompartmentEditPart;
 ...
 * @generated
 */
public class SelectorItemSemanticEditPolicy extends CrystalBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public SelectorItemSemanticEditPolicy() {
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (CrystalVisualIDRegistry.getVisualID(incomingLink) == SelectorTransitionEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (CrystalVisualIDRegistry.getVisualID(outgoingLink) == SelectorTransitionEditPart.VISUAL_ID) {
	...
	*/
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (CrystalElementTypes.SelectorTransition_4002 == req.getElementType()) {
			return getGEFWrapper(new SelectorTransitionCreateCommand(req, req.getSource(), req.getTarget()));
		}
		return null;
	}
	...
	*/
	protected Command getReorientRelationshipCommand(ReorientRelationshipRequest req) {
		...
		case SelectorTransitionEditPart.VISUAL_ID:
			return getGEFWrapper(new SelectorTransitionReorientCommand(req));
		}
