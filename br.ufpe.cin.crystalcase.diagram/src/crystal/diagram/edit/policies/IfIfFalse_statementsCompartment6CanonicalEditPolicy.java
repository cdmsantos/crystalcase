 ...
 * @generated
 */
public class IfIfFalse_statementsCompartment6CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getIfIfFalse_statementsCompartment_7137SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getIfIfFalse_statementsCompartment_7137SemanticChildren((View) getHost().getModel());
