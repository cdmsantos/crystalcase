 ...
 * @generated
 */
public class WhileWhileInterations_statementsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getWhileWhileInterations_statementsCompartment_7118SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getWhileWhileInterations_statementsCompartment_7118SemanticChildren((View) getHost().getModel());
