 ...
 * @generated
 */
public class CaseCaseDefault_statementsCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CrystalPackage.eINSTANCE.getCase_Default_statements();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getCaseCaseDefault_statementsCompartment_7125SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getCaseCaseDefault_statementsCompartment_7125SemanticChildren((View) getHost().getModel());
