 ...
 * @generated
 */
public class LoopLoopLoopStatementsCompartment6CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getLoopLoopLoopStatementsCompartment_7072SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getLoopLoopLoopStatementsCompartment_7072SemanticChildren((View) getHost().getModel());
