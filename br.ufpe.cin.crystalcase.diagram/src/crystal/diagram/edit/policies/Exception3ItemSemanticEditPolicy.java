 ...
 * @generated
 */
public class Exception3ItemSemanticEditPolicy extends CrystalBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public Exception3ItemSemanticEditPolicy() {
		super(CrystalElementTypes.Exception_3109);
	}
