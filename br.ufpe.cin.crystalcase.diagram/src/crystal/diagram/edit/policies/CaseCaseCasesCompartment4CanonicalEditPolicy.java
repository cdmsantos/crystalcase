 ...
 * @generated
 */
public class CaseCaseCasesCompartment4CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CrystalPackage.eINSTANCE.getCase_Cases();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getCaseCaseCasesCompartment_7060SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return SelectorEditPart.VISUAL_ID == CrystalVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getCaseCaseCasesCompartment_7060SemanticChildren((View) getHost().getModel());
