 ...
 * @generated
 */
public class CaseCaseOptionsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CrystalPackage.eINSTANCE.getCase_Options();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getCaseCaseOptionsCompartment_7122SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return OptionsEditPart.VISUAL_ID == CrystalVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getCaseCaseOptionsCompartment_7122SemanticChildren((View) getHost().getModel());
