 ...
 * @generated
 */
public class WhileWhileInterations_statementsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getWhileWhileInterations_statementsCompartment_7126SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getWhileWhileInterations_statementsCompartment_7126SemanticChildren((View) getHost().getModel());
