 ...
 * @generated
 */
public class Exception5ItemSemanticEditPolicy extends CrystalBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public Exception5ItemSemanticEditPolicy() {
		super(CrystalElementTypes.Exception_3283);
	}
