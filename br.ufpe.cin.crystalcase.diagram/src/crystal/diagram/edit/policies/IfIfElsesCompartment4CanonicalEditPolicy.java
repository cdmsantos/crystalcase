 ...
 * @generated
 */
public class IfIfElsesCompartment4CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getIfIfElsesCompartment_7038SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getIfIfElsesCompartment_7038SemanticChildren((View) getHost().getModel());
