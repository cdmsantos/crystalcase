 ...
 * @generated
 */
public class CaseCaseElseStatementsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getCaseCaseElseStatementsCompartment_7091SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getCaseCaseElseStatementsCompartment_7091SemanticChildren((View) getHost().getModel());
