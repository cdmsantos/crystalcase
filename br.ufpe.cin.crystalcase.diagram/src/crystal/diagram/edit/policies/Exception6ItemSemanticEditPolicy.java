 ...
 * @generated
 */
public class Exception6ItemSemanticEditPolicy extends CrystalBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public Exception6ItemSemanticEditPolicy() {
		super(CrystalElementTypes.Exception_3292);
	}
