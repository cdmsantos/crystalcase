 ...
 * @generated
 */
public class CaseCaseElseStatementsCompartment6CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getCaseCaseElseStatementsCompartment_7102SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CrystalNodeDescriptor> childDescriptors = CrystalDiagramUpdater
				.getCaseCaseElseStatementsCompartment_7102SemanticChildren((View) getHost().getModel());
