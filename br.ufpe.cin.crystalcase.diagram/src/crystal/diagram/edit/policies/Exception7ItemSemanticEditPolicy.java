 ...
 * @generated
 */
public class Exception7ItemSemanticEditPolicy extends CrystalBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public Exception7ItemSemanticEditPolicy() {
		super(CrystalElementTypes.Exception_3196);
	}
