...
public class TransitionCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof Statements) {
			return false;
		}
		if (target != null && false == target instanceof Statements) {
			return false;
		}
		if (getSource() == null) {
		...
		return CrystalBaseItemSemanticEditPolicy.getLinkConstraints().canCreateTransition_4001(getContainer(),
				getSource(), getTarget());
	}
