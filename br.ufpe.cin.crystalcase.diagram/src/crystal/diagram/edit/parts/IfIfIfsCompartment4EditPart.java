...
import crystal.diagram.edit.policies.IfIfIfsCompartment4CanonicalEditPolicy;
import crystal.diagram.edit.policies.IfIfIfsCompartment4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IfIfIfsCompartment4EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public IfIfIfsCompartment4EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.IfIfIfsCompartment4EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IfIfIfsCompartment4ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new IfIfIfsCompartment4CanonicalEditPolicy());
	}
