...
public class Loop2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof LoopLoopInterations_statementsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getLoopInterations_statementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((LoopLoopInterations_statementsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof LoopLoopInterations_statementsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getLoopInterations_statementsCompartmentFigure();
			pane.remove(((LoopLoopInterations_statementsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof LoopLoopInterations_statementsCompartment2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrystalVisualIDRegistry.getType(LoopDescription2EditPart.VISUAL_ID));
	}
