 ...
 * @generated
 */
public class ExpressionDescription2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ExpressionDescription2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Expression_3239, getParserElement(),
					CrystalVisualIDRegistry
							.getType(crystal.diagram.edit.parts.ExpressionDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
