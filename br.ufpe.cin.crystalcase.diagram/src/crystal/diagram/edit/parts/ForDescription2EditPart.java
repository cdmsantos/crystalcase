 ...
 * @generated
 */
public class ForDescription2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ForDescription2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.For_3098, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.ForDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
