 ...
 * @generated
 */
public class RecordsName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RecordsName3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Records_3073, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.RecordsName3EditPart.VISUAL_ID));
		}
		return parser;
	}
