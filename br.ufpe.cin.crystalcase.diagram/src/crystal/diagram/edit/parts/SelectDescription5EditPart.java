 ...
 * @generated
 */
public class SelectDescription5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SelectDescription5EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Select_3165, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.SelectDescription5EditPart.VISUAL_ID));
		}
		return parser;
	}
