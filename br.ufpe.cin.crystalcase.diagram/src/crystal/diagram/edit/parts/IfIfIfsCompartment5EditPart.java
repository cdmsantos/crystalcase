...
import crystal.diagram.edit.policies.IfIfIfsCompartment5CanonicalEditPolicy;
import crystal.diagram.edit.policies.IfIfIfsCompartment5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IfIfIfsCompartment5EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public IfIfIfsCompartment5EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.IfIfIfsCompartment5EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IfIfIfsCompartment5ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new IfIfIfsCompartment5CanonicalEditPolicy());
	}
