...
import crystal.diagram.edit.policies.IfIfElsesCompartmentCanonicalEditPolicy;
import crystal.diagram.edit.policies.IfIfElsesCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IfIfElsesCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public IfIfElsesCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.IfIfElsesCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IfIfElsesCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new IfIfElsesCompartmentCanonicalEditPolicy());
	}
