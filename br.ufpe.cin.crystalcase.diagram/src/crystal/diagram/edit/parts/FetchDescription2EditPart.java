 ...
 * @generated
 */
public class FetchDescription2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FetchDescription2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Fetch_3086, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.FetchDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
