 ...
 * @generated
 */
public class CaseDescription2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CaseDescription2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Case_3077, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.CaseDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
