...
import crystal.diagram.edit.policies.IfIfIfsCompartment2CanonicalEditPolicy;
import crystal.diagram.edit.policies.IfIfIfsCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IfIfIfsCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public IfIfIfsCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.IfIfIfsCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IfIfIfsCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new IfIfIfsCompartment2CanonicalEditPolicy());
	}
