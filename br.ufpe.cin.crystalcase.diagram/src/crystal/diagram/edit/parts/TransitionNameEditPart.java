...
public class TransitionNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.TransitionNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Transition_4001, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.TransitionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	...
	public class TransitionLabelFigure extends WrappingLabel {
		...
		public TransitionLabelFigure() {
			this.setText("Statement Connection");
		}
