...
import crystal.diagram.edit.policies.IfIfTrue_statementsCompartment5CanonicalEditPolicy;
import crystal.diagram.edit.policies.IfIfTrue_statementsCompartment5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IfIfTrue_statementsCompartment5EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public IfIfTrue_statementsCompartment5EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.IfIfTrue_statementsCompartment5EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IfIfTrue_statementsCompartment5ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new IfIfTrue_statementsCompartment5CanonicalEditPolicy());
	}
