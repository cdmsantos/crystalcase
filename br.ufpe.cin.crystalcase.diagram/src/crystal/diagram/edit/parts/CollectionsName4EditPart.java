 ...
 * @generated
 */
public class CollectionsName4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CollectionsName4EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Collections_3027, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.CollectionsName4EditPart.VISUAL_ID));
		}
		return parser;
	}
