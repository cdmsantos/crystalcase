 ...
 * @generated
 */
public class ExceptionDescriptionEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = CrystalParserProvider
					.getParser(
							...
							CrystalVisualIDRegistry
									.getType(crystal.diagram.edit.parts.ExceptionDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
