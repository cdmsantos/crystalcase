...
import crystal.diagram.edit.policies.IfItemSemanticEditPolicy;
...
public class IfEditPart extends ShapeNodeEditPart {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrystalVisualIDRegistry.getType(IfDescriptionEditPart.VISUAL_ID));
	}
