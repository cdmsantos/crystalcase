 ...
 * @generated
 */
public class SelectorTransitionNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.SelectorTransitionNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public SelectorTransitionNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new SelectorTransitionLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SelectorTransitionLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SelectorTransitionLabelFigure() {
