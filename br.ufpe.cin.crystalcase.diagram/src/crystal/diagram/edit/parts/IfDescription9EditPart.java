 ...
 * @generated
 */
public class IfDescription9EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IfDescription9EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.If_3038, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.IfDescription9EditPart.VISUAL_ID));
		}
		return parser;
	}
