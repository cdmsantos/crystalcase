...
import crystal.diagram.edit.policies.LoopLoopLoopStatementsCompartment10CanonicalEditPolicy;
import crystal.diagram.edit.policies.LoopLoopLoopStatementsCompartment10ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class LoopLoopLoopStatementsCompartment10EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public LoopLoopLoopStatementsCompartment10EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.LoopLoopLoopStatementsCompartment10EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new LoopLoopLoopStatementsCompartment10ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new LoopLoopLoopStatementsCompartment10CanonicalEditPolicy());
	}
