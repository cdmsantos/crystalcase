...
import crystal.diagram.edit.policies.IfIfElsesCompartment2CanonicalEditPolicy;
import crystal.diagram.edit.policies.IfIfElsesCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IfIfElsesCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public IfIfElsesCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.IfIfElsesCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IfIfElsesCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new IfIfElsesCompartment2CanonicalEditPolicy());
	}
