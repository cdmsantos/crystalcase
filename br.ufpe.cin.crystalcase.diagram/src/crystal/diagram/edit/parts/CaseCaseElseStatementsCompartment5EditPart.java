...
import crystal.diagram.edit.policies.CaseCaseElseStatementsCompartment5CanonicalEditPolicy;
import crystal.diagram.edit.policies.CaseCaseElseStatementsCompartment5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CaseCaseElseStatementsCompartment5EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public CaseCaseElseStatementsCompartment5EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.CaseCaseElseStatementsCompartment5EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CaseCaseElseStatementsCompartment5ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CaseCaseElseStatementsCompartment5CanonicalEditPolicy());
	}
