 ...
 * @generated
 */
public class WhileDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public WhileDescriptionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.While_3063, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.WhileDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
