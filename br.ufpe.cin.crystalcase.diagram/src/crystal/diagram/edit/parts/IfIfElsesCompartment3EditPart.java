...
import crystal.diagram.edit.policies.IfIfElsesCompartment3CanonicalEditPolicy;
import crystal.diagram.edit.policies.IfIfElsesCompartment3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IfIfElsesCompartment3EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public IfIfElsesCompartment3EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.IfIfElsesCompartment3EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IfIfElsesCompartment3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new IfIfElsesCompartment3CanonicalEditPolicy());
	}
