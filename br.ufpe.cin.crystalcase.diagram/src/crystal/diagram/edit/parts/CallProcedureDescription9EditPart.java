 ...
 * @generated
 */
public class CallProcedureDescription9EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallProcedureDescription9EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.CallProcedure_3050, getParserElement(),
					CrystalVisualIDRegistry
							.getType(crystal.diagram.edit.parts.CallProcedureDescription9EditPart.VISUAL_ID));
		}
		return parser;
	}
