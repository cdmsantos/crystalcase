 ...
 * @generated
 */
public class CallFunctionDescription3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallFunctionDescription3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.CallFunction_3051, getParserElement(),
					CrystalVisualIDRegistry
							.getType(crystal.diagram.edit.parts.CallFunctionDescription3EditPart.VISUAL_ID));
		}
		return parser;
	}
