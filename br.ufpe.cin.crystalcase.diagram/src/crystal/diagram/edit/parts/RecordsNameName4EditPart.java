 ...
 * @generated
 */
public class RecordsNameName4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RecordsNameName4EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Records_3028, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.RecordsNameName4EditPart.VISUAL_ID));
		}
		return parser;
	}
