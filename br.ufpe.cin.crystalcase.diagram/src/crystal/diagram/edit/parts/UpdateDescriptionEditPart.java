 ...
 * @generated
 */
public class UpdateDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public UpdateDescriptionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Update_3060, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.UpdateDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
