 ...
 * @generated
 */
public class IfDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public IfDescriptionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.If_3238, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.IfDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
