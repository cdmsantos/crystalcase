 ...
 * @generated
 */
public class CollectionsName6EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CollectionsName6EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Collections_3034, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.CollectionsName6EditPart.VISUAL_ID));
		}
		return parser;
	}
