 ...
 * @generated
 */
public class CursorName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CursorName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Cursor_3340, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.CursorName2EditPart.VISUAL_ID));
		}
		return parser;
	}
