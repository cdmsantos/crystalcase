 ...
 * @generated
 */
public class LoopDescription3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LoopDescription3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Loop_3285, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.LoopDescription3EditPart.VISUAL_ID));
		}
		return parser;
	}
