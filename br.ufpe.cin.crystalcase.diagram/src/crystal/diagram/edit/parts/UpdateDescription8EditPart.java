 ...
 * @generated
 */
public class UpdateDescription8EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UpdateDescription8EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Update_3060, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.UpdateDescription8EditPart.VISUAL_ID));
		}
		return parser;
	}
