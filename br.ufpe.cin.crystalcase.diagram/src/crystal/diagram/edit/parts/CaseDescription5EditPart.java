 ...
 * @generated
 */
public class CaseDescription5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CaseDescription5EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Case_3161, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.CaseDescription5EditPart.VISUAL_ID));
		}
		return parser;
	}
