 ...
 * @generated
 */
public class FetchDescription3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FetchDescription3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Fetch_3101, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.FetchDescription3EditPart.VISUAL_ID));
		}
		return parser;
	}
