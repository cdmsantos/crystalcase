 ...
 * @generated
 */
public class FetchDescription8EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FetchDescription8EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Fetch_3086, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.FetchDescription8EditPart.VISUAL_ID));
		}
		return parser;
	}
