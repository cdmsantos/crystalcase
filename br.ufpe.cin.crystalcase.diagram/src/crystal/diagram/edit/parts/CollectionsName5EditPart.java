 ...
 * @generated
 */
public class CollectionsName5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CollectionsName5EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Collections_3072, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.CollectionsName5EditPart.VISUAL_ID));
		}
		return parser;
	}
