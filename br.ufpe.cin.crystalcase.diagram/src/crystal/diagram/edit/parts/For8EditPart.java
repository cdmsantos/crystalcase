...
import crystal.diagram.edit.policies.For8ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class For8EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new For8ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ForDescription8EditPart) {
			((ForDescription8EditPart) childEditPart).setLabel(getPrimaryShape().getFigureForLabelFigure());
			return true;
		}
		if (childEditPart instanceof ForForForStatementsCompartment8EditPart) {
			IFigure pane = getPrimaryShape().getForForStatementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ForForForStatementsCompartment8EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ForForForStatementsCompartment8EditPart) {
			IFigure pane = getPrimaryShape().getForForStatementsCompartmentFigure();
			pane.remove(((ForForForStatementsCompartment8EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ForForForStatementsCompartment8EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrystalVisualIDRegistry.getType(ForDescription8EditPart.VISUAL_ID));
	}
