...
import crystal.diagram.edit.policies.IfIfTrue_statementsCompartment3CanonicalEditPolicy;
import crystal.diagram.edit.policies.IfIfTrue_statementsCompartment3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IfIfTrue_statementsCompartment3EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public IfIfTrue_statementsCompartment3EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.IfIfTrue_statementsCompartment3EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IfIfTrue_statementsCompartment3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new IfIfTrue_statementsCompartment3CanonicalEditPolicy());
	}
