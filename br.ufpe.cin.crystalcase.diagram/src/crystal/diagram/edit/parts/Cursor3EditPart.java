...
public class Cursor3EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Cursor3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CursorName3EditPart) {
			((CursorName3EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureCursorLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrystalVisualIDRegistry
				.getType(CursorName3EditPart.VISUAL_ID));
	}
