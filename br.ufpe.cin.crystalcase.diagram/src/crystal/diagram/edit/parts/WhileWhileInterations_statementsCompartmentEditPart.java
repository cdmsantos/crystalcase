...
import crystal.diagram.edit.policies.WhileWhileInterations_statementsCompartmentCanonicalEditPolicy;
import crystal.diagram.edit.policies.WhileWhileInterations_statementsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class WhileWhileInterations_statementsCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public WhileWhileInterations_statementsCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.WhileWhileInterations_statementsCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new WhileWhileInterations_statementsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new WhileWhileInterations_statementsCompartmentCanonicalEditPolicy());
	}
