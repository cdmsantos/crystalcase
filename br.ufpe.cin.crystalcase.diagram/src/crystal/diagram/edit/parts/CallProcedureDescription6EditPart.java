 ...
 * @generated
 */
public class CallProcedureDescription6EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallProcedureDescription6EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.CallProcedure_3149, getParserElement(),
					CrystalVisualIDRegistry
							.getType(crystal.diagram.edit.parts.CallProcedureDescription6EditPart.VISUAL_ID));
		}
		return parser;
	}
