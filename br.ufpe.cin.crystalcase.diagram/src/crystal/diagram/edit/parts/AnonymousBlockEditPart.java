...
import crystal.diagram.edit.policies.AnonymousBlockItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AnonymousBlockEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public AnonymousBlockEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createNodeShape() {
		return primaryShape = new AnonymousBlockFigure();
	}

	/**
	 * @generated
	 */
	public AnonymousBlockFigure getPrimaryShape() {
		return (AnonymousBlockFigure) primaryShape;
	}
	 ...
	 * @generated
	 */
	public class AnonymousBlockFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureAnonymousBlockLabelFigure;
		/**
		 * @generated
		 */
		private RectangleFigure fAnonymousBlockDeclarativePartCompartmentFigure;
		/**
		 * @generated
		 */
		private RectangleFigure fAnonymousBlockExecutablePartCompartmentFigure;
		...
		private void createContents() {
			...
			fAnonymousBlockDeclarativePartCompartmentFigure = new RectangleFigure();

			fAnonymousBlockDeclarativePartCompartmentFigure.setOutline(false);

			this.add(fAnonymousBlockDeclarativePartCompartmentFigure);

			fAnonymousBlockExecutablePartCompartmentFigure = new RectangleFigure();

			fAnonymousBlockExecutablePartCompartmentFigure.setOutline(false);

			this.add(fAnonymousBlockExecutablePartCompartmentFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureAnonymousBlockLabelFigure() {
			return fFigureAnonymousBlockLabelFigure;
		}

		/**
		 * @generated
		 */
		public RectangleFigure getAnonymousBlockDeclarativePartCompartmentFigure() {
			return fAnonymousBlockDeclarativePartCompartmentFigure;
		}

		/**
		 * @generated
		 */
		public RectangleFigure getAnonymousBlockExecutablePartCompartmentFigure() {
			return fAnonymousBlockExecutablePartCompartmentFigure;
		}
	 ...
	 * @generated
	 */
	static final Color THIS_FORE = new Color(null, 43, 106, 215);
