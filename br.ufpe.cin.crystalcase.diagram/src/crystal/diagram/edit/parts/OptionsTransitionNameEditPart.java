...
import crystal.diagram.edit.policies.CrystalTextSelectionEditPolicy;
 ...
 * @generated
 */
public class OptionsTransitionNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.OptionsTransitionNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public OptionsTransitionNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new CrystalTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return CrystalElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.OptionsTransition_4003, getParserElement(),
					CrystalVisualIDRegistry
							.getType(crystal.diagram.edit.parts.OptionsTransitionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, CrystalEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new OptionsTransitionLabelFigure();
	}

	/**
	 * @generated
	 */
	public class OptionsTransitionLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public OptionsTransitionLabelFigure() {
			this.setText("Case Connection");
		}
