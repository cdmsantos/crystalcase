...
import crystal.diagram.edit.policies.LoopLoopInterations_statementsCompartment3CanonicalEditPolicy;
import crystal.diagram.edit.policies.LoopLoopInterations_statementsCompartment3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class LoopLoopInterations_statementsCompartment3EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public LoopLoopInterations_statementsCompartment3EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.LoopLoopInterations_statementsCompartment3EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new LoopLoopInterations_statementsCompartment3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new LoopLoopInterations_statementsCompartment3CanonicalEditPolicy());
	}
