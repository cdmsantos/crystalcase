 ...
 * @generated
 */
public class CollectionsNameName4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CollectionsNameName4EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Collections_3027, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.CollectionsNameName4EditPart.VISUAL_ID));
		}
		return parser;
	}
