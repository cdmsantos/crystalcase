 ...
 * @generated
 */
public class OpenDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public OpenDescriptionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Open_3191, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.OpenDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
