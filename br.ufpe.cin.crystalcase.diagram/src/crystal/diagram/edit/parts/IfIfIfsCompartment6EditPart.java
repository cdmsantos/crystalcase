...
import crystal.diagram.edit.policies.IfIfIfsCompartment6CanonicalEditPolicy;
import crystal.diagram.edit.policies.IfIfIfsCompartment6ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IfIfIfsCompartment6EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public IfIfIfsCompartment6EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.IfIfIfsCompartment6EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IfIfIfsCompartment6ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new IfIfIfsCompartment6CanonicalEditPolicy());
	}
