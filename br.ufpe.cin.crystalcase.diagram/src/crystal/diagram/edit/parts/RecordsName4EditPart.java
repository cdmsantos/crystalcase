 ...
 * @generated
 */
public class RecordsName4EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RecordsName4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new CrystalTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider
					.getParser(
							CrystalElementTypes.Records_3028,
							getParserElement(),
							CrystalVisualIDRegistry
									.getType(crystal.diagram.edit.parts.RecordsName4EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					CrystalEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
