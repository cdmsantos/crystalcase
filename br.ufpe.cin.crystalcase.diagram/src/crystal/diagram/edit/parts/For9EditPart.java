...
import crystal.diagram.edit.policies.For9ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class For9EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new For9ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ForDescription9EditPart) {
			((ForDescription9EditPart) childEditPart).setLabel(getPrimaryShape().getFigureForLabelFigure());
			return true;
		}
		if (childEditPart instanceof ForForForStatementsCompartment9EditPart) {
			IFigure pane = getPrimaryShape().getForForStatementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ForForForStatementsCompartment9EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ForForForStatementsCompartment9EditPart) {
			IFigure pane = getPrimaryShape().getForForStatementsCompartmentFigure();
			pane.remove(((ForForForStatementsCompartment9EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ForForForStatementsCompartment9EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrystalVisualIDRegistry.getType(ForDescription9EditPart.VISUAL_ID));
	}
