...
import crystal.diagram.edit.policies.LoopLoopLoopStatementsCompartment3CanonicalEditPolicy;
import crystal.diagram.edit.policies.LoopLoopLoopStatementsCompartment3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class LoopLoopLoopStatementsCompartment3EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public LoopLoopLoopStatementsCompartment3EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.LoopLoopLoopStatementsCompartment3EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new LoopLoopLoopStatementsCompartment3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new LoopLoopLoopStatementsCompartment3CanonicalEditPolicy());
	}
