 ...
 * @generated
 */
public class LoopDescription9EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LoopDescription9EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Loop_3084, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.LoopDescription9EditPart.VISUAL_ID));
		}
		return parser;
	}
