 ...
 * @generated
 */
public class RecordsNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RecordsNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Records_3335, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.RecordsNameEditPart.VISUAL_ID));
		}
		return parser;
	}
