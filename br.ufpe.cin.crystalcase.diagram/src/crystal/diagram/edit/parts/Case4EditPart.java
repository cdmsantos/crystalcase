...
import crystal.diagram.edit.policies.Case4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Case4EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Case4EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Case4ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CaseDescription4EditPart) {
			((CaseDescription4EditPart) childEditPart).setLabel(getPrimaryShape().getFigureCaseLabelFigure());
			return true;
		}
		if (childEditPart instanceof CaseCaseOptionsCompartment4EditPart) {
			IFigure pane = getPrimaryShape().getCaseOptionsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((CaseCaseOptionsCompartment4EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof CaseCaseDefault_statementsCompartment4EditPart) {
			IFigure pane = getPrimaryShape().getCaseDefault_statementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((CaseCaseDefault_statementsCompartment4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CaseCaseOptionsCompartment4EditPart) {
			IFigure pane = getPrimaryShape().getCaseOptionsCompartmentFigure();
			pane.remove(((CaseCaseOptionsCompartment4EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof CaseCaseDefault_statementsCompartment4EditPart) {
			IFigure pane = getPrimaryShape().getCaseDefault_statementsCompartmentFigure();
			pane.remove(((CaseCaseDefault_statementsCompartment4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof CaseCaseOptionsCompartment4EditPart) {
			return getPrimaryShape().getCaseOptionsCompartmentFigure();
		}
		if (editPart instanceof CaseCaseDefault_statementsCompartment4EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrystalVisualIDRegistry.getType(CaseDescription4EditPart.VISUAL_ID));
	}
