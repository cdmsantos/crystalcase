...
import crystal.diagram.edit.policies.LoopLoopLoopStatementsCompartment7CanonicalEditPolicy;
import crystal.diagram.edit.policies.LoopLoopLoopStatementsCompartment7ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class LoopLoopLoopStatementsCompartment7EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public LoopLoopLoopStatementsCompartment7EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.LoopLoopLoopStatementsCompartment7EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new LoopLoopLoopStatementsCompartment7ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new LoopLoopLoopStatementsCompartment7CanonicalEditPolicy());
	}
