 ...
 * @generated
 */
public class UpdateDescription5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UpdateDescription5EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Update_3163, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.UpdateDescription5EditPart.VISUAL_ID));
		}
		return parser;
	}
