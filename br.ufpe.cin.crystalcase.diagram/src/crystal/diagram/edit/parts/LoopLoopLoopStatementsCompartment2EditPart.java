...
import crystal.diagram.edit.policies.LoopLoopLoopStatementsCompartment2CanonicalEditPolicy;
import crystal.diagram.edit.policies.LoopLoopLoopStatementsCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class LoopLoopLoopStatementsCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public LoopLoopLoopStatementsCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.LoopLoopLoopStatementsCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new LoopLoopLoopStatementsCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new LoopLoopLoopStatementsCompartment2CanonicalEditPolicy());
	}
