 ...
 * @generated
 */
public class CloseDescription9EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CloseDescription9EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Close_3087, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.CloseDescription9EditPart.VISUAL_ID));
		}
		return parser;
	}
