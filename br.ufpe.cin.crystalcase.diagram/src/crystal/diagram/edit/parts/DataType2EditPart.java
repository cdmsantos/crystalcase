...
import crystal.diagram.edit.policies.DataType2ItemSemanticEditPolicy;
...
public class DataType2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DataTypeName2EditPart) {
			((DataTypeName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureDataTypeLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrystalVisualIDRegistry.getType(DataTypeName2EditPart.VISUAL_ID));
	}
