 ...
 * @generated
 */
public class CloseDescription8EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CloseDescription8EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Close_3087, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.CloseDescription8EditPart.VISUAL_ID));
		}
		return parser;
	}
