 ...
 * @generated
 */
public class CloseDescription3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CloseDescription3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Close_3173, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.CloseDescription3EditPart.VISUAL_ID));
		}
		return parser;
	}
