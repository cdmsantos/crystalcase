...
import crystal.diagram.edit.policies.ForForForStatementsCompartment8CanonicalEditPolicy;
import crystal.diagram.edit.policies.ForForForStatementsCompartment8ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ForForForStatementsCompartment8EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public ForForForStatementsCompartment8EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.ForForForStatementsCompartment8EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ForForForStatementsCompartment8ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ForForForStatementsCompartment8CanonicalEditPolicy());
	}
