...
import crystal.diagram.edit.policies.IfIfIfsCompartment10CanonicalEditPolicy;
import crystal.diagram.edit.policies.IfIfIfsCompartment10ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IfIfIfsCompartment10EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public IfIfIfsCompartment10EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.IfIfIfsCompartment10EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IfIfIfsCompartment10ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new IfIfIfsCompartment10CanonicalEditPolicy());
	}
