...
import crystal.diagram.edit.policies.ForForInterations_statementsCompartmentCanonicalEditPolicy;
import crystal.diagram.edit.policies.ForForInterations_statementsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ForForInterations_statementsCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public ForForInterations_statementsCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.ForForInterations_statementsCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ForForInterations_statementsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ForForInterations_statementsCompartmentCanonicalEditPolicy());
	}
