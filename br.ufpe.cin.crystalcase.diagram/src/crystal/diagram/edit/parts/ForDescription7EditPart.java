 ...
 * @generated
 */
public class ForDescription7EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ForDescription7EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.For_3144, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.ForDescription7EditPart.VISUAL_ID));
		}
		return parser;
	}
