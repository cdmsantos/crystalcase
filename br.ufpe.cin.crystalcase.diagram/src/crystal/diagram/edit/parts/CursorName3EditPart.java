 ...
 * @generated
 */
public class CursorName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CursorName3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Cursor_3029, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.CursorName3EditPart.VISUAL_ID));
		}
		return parser;
	}
