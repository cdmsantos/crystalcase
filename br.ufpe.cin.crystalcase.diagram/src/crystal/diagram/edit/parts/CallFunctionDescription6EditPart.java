 ...
 * @generated
 */
public class CallFunctionDescription6EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallFunctionDescription6EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.CallFunction_3210, getParserElement(),
					CrystalVisualIDRegistry
							.getType(crystal.diagram.edit.parts.CallFunctionDescription6EditPart.VISUAL_ID));
		}
		return parser;
	}
