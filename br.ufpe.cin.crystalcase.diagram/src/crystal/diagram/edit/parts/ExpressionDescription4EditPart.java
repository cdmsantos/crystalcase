 ...
 * @generated
 */
public class ExpressionDescription4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ExpressionDescription4EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Expression_3251, getParserElement(),
					CrystalVisualIDRegistry
							.getType(crystal.diagram.edit.parts.ExpressionDescription4EditPart.VISUAL_ID));
		}
		return parser;
	}
