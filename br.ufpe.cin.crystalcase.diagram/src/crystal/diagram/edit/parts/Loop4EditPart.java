...
import crystal.diagram.edit.policies.Loop4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Loop4EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Loop4EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Loop4ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LoopDescription4EditPart) {
			((LoopDescription4EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLoopLabelFigure());
			return true;
		}
		if (childEditPart instanceof LoopLoopInterations_statementsCompartment4EditPart) {
			IFigure pane = getPrimaryShape().getLoopInterations_statementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((LoopLoopInterations_statementsCompartment4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof LoopLoopInterations_statementsCompartment4EditPart) {
			IFigure pane = getPrimaryShape().getLoopInterations_statementsCompartmentFigure();
			pane.remove(((LoopLoopInterations_statementsCompartment4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof LoopLoopInterations_statementsCompartment4EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrystalVisualIDRegistry.getType(LoopDescription4EditPart.VISUAL_ID));
	}
