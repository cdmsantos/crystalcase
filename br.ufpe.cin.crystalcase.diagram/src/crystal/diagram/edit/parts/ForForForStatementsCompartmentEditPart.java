...
import crystal.diagram.edit.policies.ForForForStatementsCompartmentCanonicalEditPolicy;
import crystal.diagram.edit.policies.ForForForStatementsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ForForForStatementsCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public ForForForStatementsCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.ForForForStatementsCompartmentEditPart_title;
	}
	...
	*/
	public IFigure createFigure() {
		...
		result.setTitle("For Statements");
		return result;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ForForForStatementsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ForForForStatementsCompartmentCanonicalEditPolicy());
	}
