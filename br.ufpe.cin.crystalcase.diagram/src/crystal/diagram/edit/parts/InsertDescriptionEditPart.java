 ...
 * @generated
 */
public class InsertDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public InsertDescriptionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Insert_3246, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.InsertDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
