 ...
 * @generated
 */
public class FetchDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FetchDescriptionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Fetch_3192, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.FetchDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
