...
import crystal.diagram.edit.policies.CaseCaseElseStatementsCompartment6CanonicalEditPolicy;
import crystal.diagram.edit.policies.CaseCaseElseStatementsCompartment6ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CaseCaseElseStatementsCompartment6EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public CaseCaseElseStatementsCompartment6EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.CaseCaseElseStatementsCompartment6EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CaseCaseElseStatementsCompartment6ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CaseCaseElseStatementsCompartment6CanonicalEditPolicy());
	}
