...
import crystal.diagram.edit.policies.CaseCaseDefault_statementsCompartmentCanonicalEditPolicy;
import crystal.diagram.edit.policies.CaseCaseDefault_statementsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CaseCaseDefault_statementsCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public CaseCaseDefault_statementsCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.CaseCaseDefault_statementsCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CaseCaseDefault_statementsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new CaseCaseDefault_statementsCompartmentCanonicalEditPolicy());
	}
