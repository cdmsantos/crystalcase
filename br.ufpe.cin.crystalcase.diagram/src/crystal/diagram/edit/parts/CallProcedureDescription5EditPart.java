 ...
 * @generated
 */
public class CallProcedureDescription5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallProcedureDescription5EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.CallProcedure_3318, getParserElement(),
					CrystalVisualIDRegistry
							.getType(crystal.diagram.edit.parts.CallProcedureDescription5EditPart.VISUAL_ID));
		}
		return parser;
	}
