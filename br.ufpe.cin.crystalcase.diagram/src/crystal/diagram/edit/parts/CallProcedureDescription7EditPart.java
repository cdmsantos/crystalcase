 ...
 * @generated
 */
public class CallProcedureDescription7EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallProcedureDescription7EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.CallProcedure_3149, getParserElement(),
					CrystalVisualIDRegistry
							.getType(crystal.diagram.edit.parts.CallProcedureDescription7EditPart.VISUAL_ID));
		}
		return parser;
	}
