 ...
 * @generated
 */
public class SelectDescription9EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SelectDescription9EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Select_3081, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.SelectDescription9EditPart.VISUAL_ID));
		}
		return parser;
	}
