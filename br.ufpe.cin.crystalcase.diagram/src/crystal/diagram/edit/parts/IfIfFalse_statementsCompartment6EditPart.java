...
import crystal.diagram.edit.policies.IfIfFalse_statementsCompartment6CanonicalEditPolicy;
import crystal.diagram.edit.policies.IfIfFalse_statementsCompartment6ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IfIfFalse_statementsCompartment6EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public IfIfFalse_statementsCompartment6EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.IfIfFalse_statementsCompartment6EditPart_title;
	}
	...
	public IFigure createFigure() {
		...
		result.setTitle("False Statements");
		return result;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IfIfFalse_statementsCompartment6ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new IfIfFalse_statementsCompartment6CanonicalEditPolicy());
	}
