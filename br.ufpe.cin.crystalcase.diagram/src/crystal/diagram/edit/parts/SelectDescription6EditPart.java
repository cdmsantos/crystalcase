 ...
 * @generated
 */
public class SelectDescription6EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SelectDescription6EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Select_3165, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.SelectDescription6EditPart.VISUAL_ID));
		}
		return parser;
	}
