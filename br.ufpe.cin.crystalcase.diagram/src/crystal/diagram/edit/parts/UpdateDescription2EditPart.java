 ...
 * @generated
 */
public class UpdateDescription2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UpdateDescription2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Update_3258, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.UpdateDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
