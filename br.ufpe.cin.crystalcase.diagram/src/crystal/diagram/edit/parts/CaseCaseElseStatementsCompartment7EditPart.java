...
import crystal.diagram.edit.policies.CaseCaseElseStatementsCompartment7CanonicalEditPolicy;
import crystal.diagram.edit.policies.CaseCaseElseStatementsCompartment7ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CaseCaseElseStatementsCompartment7EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public CaseCaseElseStatementsCompartment7EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.CaseCaseElseStatementsCompartment7EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CaseCaseElseStatementsCompartment7ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CaseCaseElseStatementsCompartment7CanonicalEditPolicy());
	}
