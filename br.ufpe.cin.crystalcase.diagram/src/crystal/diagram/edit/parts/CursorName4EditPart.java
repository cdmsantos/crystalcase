 ...
 * @generated
 */
public class CursorName4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CursorName4EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Cursor_3029, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.CursorName4EditPart.VISUAL_ID));
		}
		return parser;
	}
