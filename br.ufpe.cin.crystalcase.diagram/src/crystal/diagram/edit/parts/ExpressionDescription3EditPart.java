 ...
 * @generated
 */
public class ExpressionDescription3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ExpressionDescription3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Expression_3220, getParserElement(),
					CrystalVisualIDRegistry
							.getType(crystal.diagram.edit.parts.ExpressionDescription3EditPart.VISUAL_ID));
		}
		return parser;
	}
