...
import crystal.diagram.edit.policies.While7ItemSemanticEditPolicy;
...
public class While7EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new While7ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WhileDescription7EditPart) {
			((WhileDescription7EditPart) childEditPart).setLabel(getPrimaryShape().getFigureWhileLabelFigure());
			return true;
		}
		if (childEditPart instanceof WhileWhileWhileStatementsCompartment7EditPart) {
			IFigure pane = getPrimaryShape().getWhileWhileStatementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((WhileWhileWhileStatementsCompartment7EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof WhileWhileWhileStatementsCompartment7EditPart) {
			IFigure pane = getPrimaryShape().getWhileWhileStatementsCompartmentFigure();
			pane.remove(((WhileWhileWhileStatementsCompartment7EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof WhileWhileWhileStatementsCompartment7EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrystalVisualIDRegistry.getType(WhileDescription7EditPart.VISUAL_ID));
	}
