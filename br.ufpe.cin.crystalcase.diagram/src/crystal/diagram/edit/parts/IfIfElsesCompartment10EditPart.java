...
import crystal.diagram.edit.policies.IfIfElsesCompartment10CanonicalEditPolicy;
import crystal.diagram.edit.policies.IfIfElsesCompartment10ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IfIfElsesCompartment10EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public IfIfElsesCompartment10EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.IfIfElsesCompartment10EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IfIfElsesCompartment10ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new IfIfElsesCompartment10CanonicalEditPolicy());
	}
