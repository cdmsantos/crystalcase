 ...
 * @generated
 */
public class LoopDescription7EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LoopDescription7EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Loop_3145, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.LoopDescription7EditPart.VISUAL_ID));
		}
		return parser;
	}
