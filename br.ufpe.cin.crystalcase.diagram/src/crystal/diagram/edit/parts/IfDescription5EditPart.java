 ...
 * @generated
 */
public class IfDescription5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IfDescription5EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.If_3152, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.IfDescription5EditPart.VISUAL_ID));
		}
		return parser;
	}
