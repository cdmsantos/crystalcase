 ...
 * @generated
 */
public class LoopDescription5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LoopDescription5EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Loop_3314, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.LoopDescription5EditPart.VISUAL_ID));
		}
		return parser;
	}
