 ...
 * @generated
 */
public class AnonymousBlockDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AnonymousBlockDescriptionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.AnonymousBlock_2012, getParserElement(),
					CrystalVisualIDRegistry
							.getType(crystal.diagram.edit.parts.AnonymousBlockDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
