 ...
 * @generated
 */
public class CallProcedureDescription2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallProcedureDescription2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.CallProcedure_3103, getParserElement(),
					CrystalVisualIDRegistry
							.getType(crystal.diagram.edit.parts.CallProcedureDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
