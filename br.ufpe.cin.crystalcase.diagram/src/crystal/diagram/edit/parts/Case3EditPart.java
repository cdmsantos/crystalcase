...
import crystal.diagram.edit.policies.Case3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Case3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Case3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Case3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CaseDescription3EditPart) {
			((CaseDescription3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureCaseLabelFigure());
			return true;
		}
		if (childEditPart instanceof CaseCaseOptionsCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getCaseOptionsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((CaseCaseOptionsCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof CaseCaseDefault_statementsCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getCaseDefault_statementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((CaseCaseDefault_statementsCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CaseCaseOptionsCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getCaseOptionsCompartmentFigure();
			pane.remove(((CaseCaseOptionsCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof CaseCaseDefault_statementsCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getCaseDefault_statementsCompartmentFigure();
			pane.remove(((CaseCaseDefault_statementsCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof CaseCaseOptionsCompartment3EditPart) {
			return getPrimaryShape().getCaseOptionsCompartmentFigure();
		}
		if (editPart instanceof CaseCaseDefault_statementsCompartment3EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrystalVisualIDRegistry.getType(CaseDescription3EditPart.VISUAL_ID));
	}
