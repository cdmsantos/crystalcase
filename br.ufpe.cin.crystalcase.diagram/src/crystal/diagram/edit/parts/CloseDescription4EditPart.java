 ...
 * @generated
 */
public class CloseDescription4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CloseDescription4EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Close_3173, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.CloseDescription4EditPart.VISUAL_ID));
		}
		return parser;
	}
