 ...
 * @generated
 */
public class CallFunctionDescription4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallFunctionDescription4EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.CallFunction_3306, getParserElement(),
					CrystalVisualIDRegistry
							.getType(crystal.diagram.edit.parts.CallFunctionDescription4EditPart.VISUAL_ID));
		}
		return parser;
	}
