...
import crystal.diagram.edit.policies.ForForForStatementsCompartment4CanonicalEditPolicy;
import crystal.diagram.edit.policies.ForForForStatementsCompartment4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ForForForStatementsCompartment4EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public ForForForStatementsCompartment4EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.ForForForStatementsCompartment4EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ForForForStatementsCompartment4ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ForForForStatementsCompartment4CanonicalEditPolicy());
	}
