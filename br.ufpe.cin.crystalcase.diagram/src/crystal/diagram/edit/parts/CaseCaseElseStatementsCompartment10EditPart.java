...
import crystal.diagram.edit.policies.CaseCaseElseStatementsCompartment10CanonicalEditPolicy;
import crystal.diagram.edit.policies.CaseCaseElseStatementsCompartment10ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CaseCaseElseStatementsCompartment10EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public CaseCaseElseStatementsCompartment10EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.CaseCaseElseStatementsCompartment10EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CaseCaseElseStatementsCompartment10ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CaseCaseElseStatementsCompartment10CanonicalEditPolicy());
	}
