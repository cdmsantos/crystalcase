 ...
 * @generated
 */
public class CloseDescription6EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CloseDescription6EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Close_3330, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.CloseDescription6EditPart.VISUAL_ID));
		}
		return parser;
	}
