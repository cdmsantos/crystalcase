 ...
 * @generated
 */
public class ExpressionDescription8EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ExpressionDescription8EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Expression_3218, getParserElement(),
					CrystalVisualIDRegistry
							.getType(crystal.diagram.edit.parts.ExpressionDescription8EditPart.VISUAL_ID));
		}
		return parser;
	}
