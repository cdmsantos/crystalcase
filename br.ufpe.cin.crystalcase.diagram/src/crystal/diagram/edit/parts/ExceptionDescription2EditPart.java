 ...
 * @generated
 */
public class ExceptionDescription2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ExceptionDescription2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Exception_3240, getParserElement(),
					CrystalVisualIDRegistry
							.getType(crystal.diagram.edit.parts.ExceptionDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
