 ...
 * @generated
 */
public class SelectDescription2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SelectDescription2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Select_3260, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.SelectDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
