...
public class If6EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof IfIfIfsCompartment6EditPart) {
			IFigure pane = getPrimaryShape().getIfIfsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((IfIfIfsCompartment6EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof IfIfElsesCompartment6EditPart) {
			IFigure pane = getPrimaryShape().getIfElsesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((IfIfElsesCompartment6EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof IfIfIfsCompartment6EditPart) {
			IFigure pane = getPrimaryShape().getIfIfsCompartmentFigure();
			pane.remove(((IfIfIfsCompartment6EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof IfIfElsesCompartment6EditPart) {
			IFigure pane = getPrimaryShape().getIfElsesCompartmentFigure();
			pane.remove(((IfIfElsesCompartment6EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof IfIfIfsCompartment6EditPart) {
			return getPrimaryShape().getIfIfsCompartmentFigure();
		}
		if (editPart instanceof IfIfElsesCompartment6EditPart) {
