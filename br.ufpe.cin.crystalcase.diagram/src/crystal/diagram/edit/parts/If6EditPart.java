...
import crystal.diagram.edit.policies.If6ItemSemanticEditPolicy;
...
public class If6EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new If6ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof IfDescription6EditPart) {
			((IfDescription6EditPart) childEditPart).setLabel(getPrimaryShape().getFigureIfLabelFigure());
			return true;
		}
		if (childEditPart instanceof IfIfTrue_statementsCompartment6EditPart) {
			IFigure pane = getPrimaryShape().getIfTrue_statementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((IfIfTrue_statementsCompartment6EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof IfIfFalse_statementsCompartment6EditPart) {
			IFigure pane = getPrimaryShape().getIfFalse_statementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((IfIfFalse_statementsCompartment6EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof IfIfTrue_statementsCompartment6EditPart) {
			IFigure pane = getPrimaryShape().getIfTrue_statementsCompartmentFigure();
			pane.remove(((IfIfTrue_statementsCompartment6EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof IfIfFalse_statementsCompartment6EditPart) {
			IFigure pane = getPrimaryShape().getIfFalse_statementsCompartmentFigure();
			pane.remove(((IfIfFalse_statementsCompartment6EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof IfIfTrue_statementsCompartment6EditPart) {
			return getPrimaryShape().getIfTrue_statementsCompartmentFigure();
		}
		if (editPart instanceof IfIfFalse_statementsCompartment6EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrystalVisualIDRegistry.getType(IfDescription6EditPart.VISUAL_ID));
	}
