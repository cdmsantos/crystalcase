 ...
 * @generated
 */
public class SelectDescription3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SelectDescription3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Select_3096, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.SelectDescription3EditPart.VISUAL_ID));
		}
		return parser;
	}
