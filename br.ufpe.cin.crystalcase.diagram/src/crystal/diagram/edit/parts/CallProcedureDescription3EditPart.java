 ...
 * @generated
 */
public class CallProcedureDescription3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallProcedureDescription3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.CallProcedure_3289, getParserElement(),
					CrystalVisualIDRegistry
							.getType(crystal.diagram.edit.parts.CallProcedureDescription3EditPart.VISUAL_ID));
		}
		return parser;
	}
