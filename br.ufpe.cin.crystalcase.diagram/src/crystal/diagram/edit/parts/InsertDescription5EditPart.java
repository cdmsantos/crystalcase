 ...
 * @generated
 */
public class InsertDescription5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InsertDescription5EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Insert_3308, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.InsertDescription5EditPart.VISUAL_ID));
		}
		return parser;
	}
