 ...
 * @generated
 */
public class CaseDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CaseDescriptionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Case_3058, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.CaseDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
