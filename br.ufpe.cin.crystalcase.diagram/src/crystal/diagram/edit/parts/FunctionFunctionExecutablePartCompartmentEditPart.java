...
import crystal.diagram.edit.policies.FunctionFunctionExecutablePartCompartmentCanonicalEditPolicy;
import crystal.diagram.edit.policies.FunctionFunctionExecutablePartCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class FunctionFunctionExecutablePartCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public FunctionFunctionExecutablePartCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.FunctionFunctionExecutablePartCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new FunctionFunctionExecutablePartCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new FunctionFunctionExecutablePartCompartmentCanonicalEditPolicy());
	}
