 ...
 * @generated
 */
public class DeleteDescription5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DeleteDescription5EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Delete_3310, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.DeleteDescription5EditPart.VISUAL_ID));
		}
		return parser;
	}
