...
import crystal.diagram.edit.policies.CursorItemSemanticEditPolicy;
...
public class CursorEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CursorItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CursorNameEditPart) {
			((CursorNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureCursorLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrystalVisualIDRegistry.getType(CursorNameEditPart.VISUAL_ID));
	}
