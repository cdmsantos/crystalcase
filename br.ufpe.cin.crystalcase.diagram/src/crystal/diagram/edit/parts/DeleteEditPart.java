...
import crystal.diagram.edit.policies.DeleteItemSemanticEditPolicy;
...
public class DeleteEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DeleteItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DeleteDescriptionEditPart) {
			((DeleteDescriptionEditPart) childEditPart).setLabel(getPrimaryShape().getFigureDeleteLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrystalVisualIDRegistry.getType(DeleteDescriptionEditPart.VISUAL_ID));
	}
