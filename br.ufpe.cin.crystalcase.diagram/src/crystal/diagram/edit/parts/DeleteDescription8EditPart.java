 ...
 * @generated
 */
public class DeleteDescription8EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DeleteDescription8EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Delete_3061, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.DeleteDescription8EditPart.VISUAL_ID));
		}
		return parser;
	}
