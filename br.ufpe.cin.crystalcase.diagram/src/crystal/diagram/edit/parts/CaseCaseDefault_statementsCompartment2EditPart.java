...
import crystal.diagram.edit.policies.CaseCaseDefault_statementsCompartment2CanonicalEditPolicy;
import crystal.diagram.edit.policies.CaseCaseDefault_statementsCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CaseCaseDefault_statementsCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public CaseCaseDefault_statementsCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.CaseCaseDefault_statementsCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CaseCaseDefault_statementsCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new CaseCaseDefault_statementsCompartment2CanonicalEditPolicy());
	}
