...
import crystal.diagram.edit.policies.CaseCaseElseStatementsCompartmentCanonicalEditPolicy;
import crystal.diagram.edit.policies.CaseCaseElseStatementsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CaseCaseElseStatementsCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public CaseCaseElseStatementsCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.CaseCaseElseStatementsCompartmentEditPart_title;
	}
	...
	*/
	public IFigure createFigure() {
		...
		result.setTitle("Else Statements");
		return result;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CaseCaseElseStatementsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CaseCaseElseStatementsCompartmentCanonicalEditPolicy());
	}
