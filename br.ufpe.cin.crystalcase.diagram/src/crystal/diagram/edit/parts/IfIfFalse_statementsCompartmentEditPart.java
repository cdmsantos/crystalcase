...
import crystal.diagram.edit.policies.IfIfFalse_statementsCompartmentCanonicalEditPolicy;
import crystal.diagram.edit.policies.IfIfFalse_statementsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IfIfFalse_statementsCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public IfIfFalse_statementsCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.IfIfFalse_statementsCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IfIfFalse_statementsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new IfIfFalse_statementsCompartmentCanonicalEditPolicy());
	}
