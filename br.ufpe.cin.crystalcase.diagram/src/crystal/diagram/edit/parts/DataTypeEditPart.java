...
import crystal.diagram.edit.policies.DataTypeItemSemanticEditPolicy;
...
public class DataTypeEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DataTypeNameEditPart) {
			((DataTypeNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureDataTypeLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrystalVisualIDRegistry.getType(DataTypeNameEditPart.VISUAL_ID));
	}
