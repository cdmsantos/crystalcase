 ...
 * @generated
 */
public class ForDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ForDescriptionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.For_3254, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.ForDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
