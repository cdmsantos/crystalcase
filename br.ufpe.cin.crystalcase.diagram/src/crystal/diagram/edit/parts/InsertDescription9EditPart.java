 ...
 * @generated
 */
public class InsertDescription9EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InsertDescription9EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Insert_3040, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.InsertDescription9EditPart.VISUAL_ID));
		}
		return parser;
	}
