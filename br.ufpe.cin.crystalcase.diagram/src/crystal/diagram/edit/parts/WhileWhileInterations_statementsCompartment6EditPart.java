...
import crystal.diagram.edit.policies.WhileWhileInterations_statementsCompartment6CanonicalEditPolicy;
import crystal.diagram.edit.policies.WhileWhileInterations_statementsCompartment6ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class WhileWhileInterations_statementsCompartment6EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public WhileWhileInterations_statementsCompartment6EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.WhileWhileInterations_statementsCompartment6EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new WhileWhileInterations_statementsCompartment6ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new WhileWhileInterations_statementsCompartment6CanonicalEditPolicy());
	}
