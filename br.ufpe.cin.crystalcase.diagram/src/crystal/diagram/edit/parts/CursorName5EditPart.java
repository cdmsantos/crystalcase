 ...
 * @generated
 */
public class CursorName5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CursorName5EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Cursor_3029, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.CursorName5EditPart.VISUAL_ID));
		}
		return parser;
	}
