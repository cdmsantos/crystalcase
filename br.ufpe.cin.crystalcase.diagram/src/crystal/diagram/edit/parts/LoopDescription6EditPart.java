 ...
 * @generated
 */
public class LoopDescription6EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LoopDescription6EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Loop_3205, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.LoopDescription6EditPart.VISUAL_ID));
		}
		return parser;
	}
