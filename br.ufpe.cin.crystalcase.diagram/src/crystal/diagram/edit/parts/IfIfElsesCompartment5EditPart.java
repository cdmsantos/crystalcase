...
import crystal.diagram.edit.policies.IfIfElsesCompartment5CanonicalEditPolicy;
import crystal.diagram.edit.policies.IfIfElsesCompartment5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IfIfElsesCompartment5EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public IfIfElsesCompartment5EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.IfIfElsesCompartment5EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IfIfElsesCompartment5ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new IfIfElsesCompartment5CanonicalEditPolicy());
	}
