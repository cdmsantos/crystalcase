 ...
 * @generated
 */
public class CallFunctionDescription8EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallFunctionDescription8EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.CallFunction_3089, getParserElement(),
					CrystalVisualIDRegistry
							.getType(crystal.diagram.edit.parts.CallFunctionDescription8EditPart.VISUAL_ID));
		}
		return parser;
	}
