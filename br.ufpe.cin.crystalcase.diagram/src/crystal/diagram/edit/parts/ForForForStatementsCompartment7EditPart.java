...
import crystal.diagram.edit.policies.ForForForStatementsCompartment7CanonicalEditPolicy;
import crystal.diagram.edit.policies.ForForForStatementsCompartment7ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ForForForStatementsCompartment7EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public ForForForStatementsCompartment7EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.ForForForStatementsCompartment7EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ForForForStatementsCompartment7ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ForForForStatementsCompartment7CanonicalEditPolicy());
	}
