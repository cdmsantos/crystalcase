...
import crystal.diagram.edit.policies.SelectItemSemanticEditPolicy;
...
public class SelectEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SelectDescriptionEditPart) {
			((SelectDescriptionEditPart) childEditPart).setLabel(getPrimaryShape().getFigureSelectLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrystalVisualIDRegistry.getType(SelectDescriptionEditPart.VISUAL_ID));
	}
