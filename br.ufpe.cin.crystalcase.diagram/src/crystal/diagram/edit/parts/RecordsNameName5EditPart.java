 ...
 * @generated
 */
public class RecordsNameName5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RecordsNameName5EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrystalParserProvider.getParser(CrystalElementTypes.Records_3073, getParserElement(),
					CrystalVisualIDRegistry.getType(crystal.diagram.edit.parts.RecordsNameName5EditPart.VISUAL_ID));
		}
		return parser;
	}
