...
import crystal.diagram.edit.policies.Loop5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Loop5EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Loop5EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Loop5ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LoopDescription5EditPart) {
			((LoopDescription5EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLoopLabelFigure());
			return true;
		}
		if (childEditPart instanceof LoopLoopInterations_statementsCompartment5EditPart) {
			IFigure pane = getPrimaryShape().getLoopInterations_statementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((LoopLoopInterations_statementsCompartment5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof LoopLoopInterations_statementsCompartment5EditPart) {
			IFigure pane = getPrimaryShape().getLoopInterations_statementsCompartmentFigure();
			pane.remove(((LoopLoopInterations_statementsCompartment5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof LoopLoopInterations_statementsCompartment5EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrystalVisualIDRegistry.getType(LoopDescription5EditPart.VISUAL_ID));
	}
