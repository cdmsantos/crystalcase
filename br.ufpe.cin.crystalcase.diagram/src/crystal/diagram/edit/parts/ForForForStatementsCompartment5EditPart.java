...
import crystal.diagram.edit.policies.ForForForStatementsCompartment5CanonicalEditPolicy;
import crystal.diagram.edit.policies.ForForForStatementsCompartment5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ForForForStatementsCompartment5EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public ForForForStatementsCompartment5EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.ForForForStatementsCompartment5EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ForForForStatementsCompartment5ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CrystalVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ForForForStatementsCompartment5CanonicalEditPolicy());
	}
