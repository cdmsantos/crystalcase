...
public class AnonymousBlockItemProvider extends SubprogramsItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AnonymousBlock_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AnonymousBlock_description_feature", "_UI_AnonymousBlock_type"),
				 CrystalPackage.Literals.ANONYMOUS_BLOCK__DESCRIPTION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((AnonymousBlock)object).getDescription();
