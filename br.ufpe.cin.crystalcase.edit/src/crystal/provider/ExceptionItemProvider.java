...
/**
 * This is the item provider adapter for a {@link crystal.Exception} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExceptionItemProvider extends AdditionalOperationsItemProvider {
	/**
	...
	protected void addCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Exception_code_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Exception_code_feature", "_UI_Exception_type"),
				 CrystalPackage.Literals.EXCEPTION__CODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
