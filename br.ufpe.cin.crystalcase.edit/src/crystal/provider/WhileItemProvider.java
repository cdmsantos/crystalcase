...
/**
 * This is the item provider adapter for a {@link crystal.While} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WhileItemProvider extends StatementsItemProvider {
	/**
	...
	protected void addCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_While_code_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_While_code_feature", "_UI_While_type"),
				 CrystalPackage.Literals.WHILE__CODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
