...
/**
 * This is the item provider adapter for a {@link crystal.Cursor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CursorItemProvider extends DataAbstractionsItemProvider {
	/**
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Cursor"));
	}
	...
	public String getText(Object object) {
		String label = ((Cursor)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Cursor_type") :
			getString("_UI_Cursor_type") + " " + label;
	}
