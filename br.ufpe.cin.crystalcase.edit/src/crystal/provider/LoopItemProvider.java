...
/**
 * This is the item provider adapter for a {@link crystal.Loop} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LoopItemProvider extends StatementsItemProvider {
	/**
	...
	protected void addBreakConditionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Loop_breakCondition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Loop_breakCondition_feature", "_UI_Loop_type"),
				 CrystalPackage.Literals.LOOP__BREAK_CONDITION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CrystalPackage.Literals.LOOP__LOOP_STATEMENTS);
		}
