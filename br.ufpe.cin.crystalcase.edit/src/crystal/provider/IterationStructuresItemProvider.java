...
/**
 * This is the item provider adapter for a {@link crystal.IterationStructures} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IterationStructuresItemProvider extends StatementsItemProvider {
	/**
	 ...
	 * @generated
	 */
	public IterationStructuresItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CrystalPackage.Literals.ITERATION_STRUCTURES__INTERATIONS_STATEMENTS);
		}
	...
	public String getText(Object object) {
		String label = ((IterationStructures)object).getDescription();
		return label == null || label.length() == 0 ?
			getString("_UI_IterationStructures_type") :
			getString("_UI_IterationStructures_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IterationStructures.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CrystalPackage.Literals.ITERATION_STRUCTURES__INTERATIONS_STATEMENTS,
