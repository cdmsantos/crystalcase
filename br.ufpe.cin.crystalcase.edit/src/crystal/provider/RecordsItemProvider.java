...
/**
 * This is the item provider adapter for a {@link crystal.Records} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RecordsItemProvider extends DataAbstractionsItemProvider {
	/**
	 ...
	 * @generated
	 */
	public RecordsItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Records"));
	}
	...
	public String getText(Object object) {
		String label = ((Records)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Records_type") :
			getString("_UI_Records_type") + " " + label;
	}
