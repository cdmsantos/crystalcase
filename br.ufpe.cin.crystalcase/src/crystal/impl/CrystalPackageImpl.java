...
public class CrystalPackageImpl extends EPackageImpl implements CrystalPackage {
	 ...
	 * @generated
	 */
	public EAttribute getIf_CodeElse() {
	...
	public void createPackageContents() {
		...
		createEAttribute(ifEClass, IF__CODE_ELSE);
		...
		createEAttribute(forEClass, FOR__CODE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getCollections_TypeName(), ecorePackage.getEString(), "typeName", "", 0, 1, Collections.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRecords_TypeName(), ecorePackage.getEString(), "typeName", "", 0, 1, Records.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getStatements_IsStart(), ecorePackage.getEBoolean(), "isStart", "false", 0, 1, Statements.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getException_Code(), ecorePackage.getEString(), "code", "EXCEPTION WHEN no_data_found THEN DBMS_OUTPUT.PUT_LINE(\'There arent data registred\')", 0, 1, crystal.Exception.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getIf_Code(), ecorePackage.getEString(), "code", "Type de IF code", 0, 1, If.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getIf_CodeElse(), ecorePackage.getEString(), "codeElse", "Type de ELSE code", 0, 1, If.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCase_Condition(), ecorePackage.getEString(), "condition", "Type the CASE expression", 0, 1, Case.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCase_Code(), ecorePackage.getEString(), "code", "Type de CASE code", 0, 1, Case.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getWhile_Code(), ecorePackage.getEString(), "code", "Type the WHILE code", 0, 1, While.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getFor_Code(), ecorePackage.getEString(), "code", "Type the FOR code", 0, 1, For.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
