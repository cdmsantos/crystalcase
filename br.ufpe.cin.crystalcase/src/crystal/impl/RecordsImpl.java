...
public class RecordsImpl extends DataAbstractionsImpl implements Records {
	 ...
	 * @ordered
	 */
	protected static final String CLASS_NAME_EDEFAULT = "Records";
	...
	protected EClass eStaticClass() {
		return CrystalPackage.Literals.RECORDS;
	}
	...
	public void setCode(String newCode) {
		...
		code = newCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CrystalPackage.RECORDS__CODE, oldCode, code));
	}
