...
public class LoopImpl extends StatementsImpl implements Loop {
	 ...
	 * @ordered
	 */
	protected static final String CODE_EDEFAULT = "Type the code of the Loop statement";
	/**
	...
	public void setCode(String newCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CrystalPackage.LOOP__CODE, oldCode, code));
	}
